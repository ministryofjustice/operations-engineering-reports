...
For more information, please review the detailed MoJ GitHub standards [here](TODO: Add link).

### What are reports?

GitHub repository standards reports are generated by the Operations Engineering team to track the compliance of GitHub repositories with the MoJ GitHub organisation. These reports are generated using a combination of GitHub's REST API and the GitHub GraphQL API. A report is generated for each repository, and contains the following information:
...
- **Repository compliance status reason**: The reason for the repository's compliance status (e.g. missing licence file, missing .gitignore file, etc.).
