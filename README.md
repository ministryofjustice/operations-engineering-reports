...
Welcome to the Operations Engineering Reports project, a Flask-based web application developed and maintained by the Ministry of Justice's [Operations Engineering Team](https://operations-engineering.service.justice.gov.uk). Our goal is to provide a unified and easy-to-use platform to visualize and track the compliance of GitHub repositories with the GitHub Repository Standards as established by the Ministry of Justice.

This application interfaces with AWS DynamoDB to store and fetch the data pertaining to each repository's compliance status. It also supports user authentication via Auth0, enabling secure viewing and management of private repository reports.

With a sleek, user-friendly interface designed following the Government UK (GovUK) styling guidelines, the application presents the compliance status in an intuitive format. Users can conveniently search for public repositories using a Google-style search bar, and view the results in a clean, well-organized list.

In addition to its main functionality of displaying GitHub repository reports, the application has been built with scalability in mind. Our vision is to expand its capabilities to house additional types of reports generated by the Operations Engineering team, making it a central hub for all compliance-related information.

Explore our live site [here](https://operations-engineering-reports-prod.cloud-platform.service.justice.gov.uk/).

## Table of Contents

1. [Prerequisites](#prerequisites)
1. [Test Reports](#reports)
