!(function (t, e) {
        ...
        Object.defineProperty(Function.prototype, "bind", {
          value: function (e) {
            ...
            return (
              ...
              f.prototype && ((r.prototype = f.prototype), (b.prototype = new r()), (r.prototype = null)),
              b
            );
          },
        });
                ...
                d = function () {
                  ...
                  if (n.length)
                    for (e = 0; e < n.length; ++e)
                      if (o.test(n[e]))
                        throw (
                          (((t = new SyntaxError('String "' + n[e] + '" contains an invalid character')).code = 5),
                  ...
                  for (
                    "" ===
                      (a =
                        "object" == typeof i[s]
                          ? ("" + i[s].baseVal).replace(/^\s+|\s+$/g, "").split(o)
                          : ("" + i[s]).replace(/^\s+|\s+$/g, "").split(o))[0] && (a = []),
                      l = {},
                      e = 0;
                    e < a.length;
                    ++e
        ...
        (function () {
          if (!window.Element || window.HTMLElement) {
            ...
            a.attachEvent("onpropertychange", function (t) {
              ...
              s() || ((document.onreadystatechange = s), (t = setInterval(s, 25))),
          ...
          function s() {
            return (
              ...
              !(!document.body || document.body.prototype || !/(complete|interactive)/.test(document.readyState)) &&
                (c(document, !0), t && document.body.prototype && clearTimeout(t), !!document.body.prototype)
            );
          }
        })();
    }.call(("object" == typeof window && window) || ("object" == typeof self && self) || ("object" == typeof global && global) || {}),
            ...
            (window.Event = Window.prototype.Event =
              function (t, e) {
                ...
                return (
                  ...
                  (n.bubbles = !(!e || e.bubbles === s) && e.bubbles),
                  (n.cancelable = !(!e || e.cancelable === s) && e.cancelable),
                  n
                );
              }),
  ...
  (i.prototype.init = function () {
    ...
    (i.prototype.polyfillDetails = function () {
      ...
      e &&
        ...
        this.$module.hasAttribute("open")
          ...
          : (e.setAttribute("aria-expanded", "false"), (n.style.display = "none")),
    ...
    (r.prototype.defaults = { characterCountAttribute: "data-maxlength", wordCountAttribute: "data-maxwords" }),
    ...
    (h.prototype.init = function () {
      this.$module &&
        ...
        this.$linkedElement && this.$module.addEventListener("click", this.focusLinkedElement.bind(this)));
    }),
    ...
    (t.initAll = function m(t) {
      ...
      s(e.querySelectorAll('[data-module="govuk-button"]'), function (t) {
        ...
        s(e.querySelectorAll('[data-module="govuk-notification-banner"]'), function (t) {
          new c(t).init();
        }),
        s(e.querySelectorAll('[data-module="govuk-radios"]'), function (t) {
          new d(t).init();
        }),
        new h(e.querySelector('[data-module="govuk-skip-link"]')).init(),
        s(e.querySelectorAll('[data-module="govuk-tabs"]'), function (t) {
          new p(t).init();
        });
    }),
    (t.Accordion = n),
